...
function addMessage(text, sender = "bot") {
    ...
    avatar.src = sender === "user" ? "img/user_avatar.png" : "img/bot_avatar.png";
...
function handleCommand(input) {
    if (input === "/start") {
        ...
        addMessage(`Привет ${userName}, приятно познакомится. Я умею считать, введи числа которые надо посчитать`);
